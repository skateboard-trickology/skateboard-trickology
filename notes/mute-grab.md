...
## Ontology notes
- The IRI remains `:MuteGrab` (frozen at creation).
- `skos:prefLabel "Weddle grab"@en`, `skos:altLabel "Mute grab"@en`.
- Candidate: `skos:changeNote "Renamed from mute grab in 2022 in honor
  of Chris Weddle."@en` once sources are confirmed.
